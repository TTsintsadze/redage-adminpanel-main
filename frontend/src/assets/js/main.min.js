    ...
    $("#sidebar-toggle").on("click", function() {
        ...
        function() {
            ...
            $(".accordion-menu li a").on("click", function(e) {
                ...
                if (o.length) return console.log(o.length), n.hasClass("open") ? (o.slideUp(200), n.removeClass("open"), t.update()) : (a.length && ($(".accordion-menu > li.open > ul").slideUp(200), a.removeClass("open"), t.update()), o.slideDown(200), n.addClass("open"), t.update()), !1
